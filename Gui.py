...
class Platform(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Cybernated Gate Pass Security System")
        ...
        if folder:
            ...
            def ShowMessage():
                ...
                for messages in list_of_unknown:
                    ...
                    intruder_picture = customtkinter.CTkImage(Image.open(f"unknown_pictures/{messages}"),
                                                              size=(400, 300))
            ...
            box_5_button = customtkinter.CTkButton(master=box_3, text='Open directory for intruder images',
                                                   border_width=1,
                                                   border_color='#b2beb5',
